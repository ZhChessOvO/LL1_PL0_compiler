    ...
    public static ArrayList<Token> getsym(String input) {
        ...
        while (index < str.length()) {
            ...
            if (keywords.length() != 0) {
                if (temp.length() != 0) {
                    wordToken.add(new Token("IDENT", temp.toString(), "", temp.toString()));
                    temp = new StringBuilder();
                }
                wordToken.add(new Token(keywords.toUpperCase() + "SYM", "", "", keywords));
                ...
                wordToken.add(new Token("NUMBER", "", number, number));
                index += number.length();
                ...
                wordToken.add(new Token("SYM_" + operator, "", "", operator));
                ...
                wordToken.add(new Token("SYM_" + delimiters, "", "", delimiters));
